    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            $tour->update([
                ...
                'price_per_person' => $request->price_per_person ?? $tour->price_per_person,
                'discount' => $request->discount ?? $tour->discount,
                'badge' => $request->badge ?? $tour->badge,
                'rating' => $request->rating ?? $tour->rating,
                'review_count' => $request->review_count ?? $tour->review_count,
